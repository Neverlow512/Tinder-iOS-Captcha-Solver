...
def find_captcha_element(driver):
    try:
        captcha_element = driver.find_element(AppiumBy.XPATH, '//XCUIElementTypeApplication[@name="Tinder"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeWebView/XCUIElementTypeWebView/XCUIElementTypeWebView/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther')
